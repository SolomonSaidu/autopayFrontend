...
export default function Sidebar({ activeView, onViewChange, onLogout, user }) {
  ...
  return (
    <aside className="w-64 h-full bg-zinc-950 text-zinc-400 flex flex-col justify-between p-4 border-r border-zinc-800 flex-shrink-0">
